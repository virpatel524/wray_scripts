...
data = list(csv.reader(open('/home/vdp5/data/gene_finder/origin_sequences/all_archive/ASM241v2.gb'),delimiter='\t'))
chrom2seq = {}
...
base = '/home/vdp5/data/gene_finder/origin_sequences/splitup/ASM241v2/'
